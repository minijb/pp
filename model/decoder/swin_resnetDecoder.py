...
class Swin_decoder(nn.ModuleList):
    ...
    def forward(self, feature_maps):
        ...
        out3 = self.upconv3(feature_maps[3]) # 1024 --> 512  8 --> 16
        out3 = torch.cat([out3, feature_maps[2] ], dim=1) # 512 + 1024 = 1536 
        
        out2 = self.upconv2(out3) # 1536 --> 768 ; 16 -> 32
        out2 = torch.cat([out2, feature_maps[1]], dim=1) # 768 * 2 = 1,536 
        
        out1 = self.upconv1(out2) # 1536 -> 768 32 -> 64
        out1 = torch.cat([out1, feature_maps[0]], dim=1) #768 + 128 = 896
        
        out = self.upconv0(out1)
        out = self.upconv(out)
